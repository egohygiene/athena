...
id: athena-design-system
title: Athena Design System
...
This document defines reusable semantic language for Athena's documentation, terminal output, diagrams, reports, sites, and future interactive surfaces. It does not freeze a framework, component library, or final visual identity.
...
The expression should remain library-like, archival, richly browsable, and careful about origin and rights while allowing product-specific identity to vary inside Ego Hygiene's broader family.
