window.onload = function () {
    ...
    var select = new mdc.select.MDCSelect(document.querySelector(".language-picker .mdc-select"));

    select.listen("change", function () {
        var redirectUrl = document.querySelector("#language-picker-dropdown").value;
